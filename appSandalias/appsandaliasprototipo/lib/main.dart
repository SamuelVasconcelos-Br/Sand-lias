...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const GaivotaPage(),
    );
  }
}

class GaivotaPage extends StatelessWidget {
  const GaivotaPage({super.key});
    ...
    return Scaffold(
      appBar: AppBar(
        leading: IconButton(
          ...
          onPressed: () {
            // Define a ação do botão de voltar aqui
          },
        ),
          ...
          child: Column(
            ...
            children: [
              ClipRRect(
                ...
                child: Image.asset('assets/images/animal1.jpeg', // Altere para o caminho correto da sua imagem
              ...
              Column(
                children: [
                  _buildCharacteristicCard(
                    'assets/images/animal1.jpeg', // Altere para o caminho correto da sua imagem
                  ...
                  const SizedBox(height: 10),
                  _buildCharacteristicCard(
                    'assets/images/animal2.png', // Altere para o caminho correto da sua imagem
                  ...
                  const SizedBox(height: 10),
                  _buildCharacteristicCard(
                    'assets/images/animal3.jpeg', // Altere para o caminho correto da sua imagem
                    'O gaivotão é a ave marinha mais conhecida do nosso país.',
                  ),
                ],
              ),
              const SizedBox(height: 10),
              ...
              const SizedBox(height: 10),
              const Text(
                '7. Mantenha distância: Se uma gaivota parecer especialmente ou agressiva, é melhor manter distância e evitar confrontos.',
                style: TextStyle(fontSize: 16),
              ),
            ],
          ),
